...
local function CreateFloweryAIUI(ScreenGui, onClose)
    ...
    local function RefreshPersonaPanel()
        ...
        addBtn.MouseButton1Click:Connect(function()
            ...
            -- Only one form/choice at a time
            ClearTempForms()
...
local function CreateMainInterface(ScreenGui)
    ...
    SettingsScroll.BackgroundTransparency = 1 SettingsScroll.BorderSizePixel = 0 SettingsScroll.CanvasSize = UDim2.new(0, 0, 0, 340)
    ...
    TutorialBtn.MouseButton1Down:Connect(function()
        ...
        while isHoldingTutorial do
            ...
            if holdTime >= 1.5 then
                ...
                task.wait(0.3)
                CreateFloweryAIUI(ScreenGui, function()
                    -- on close, restore button
...
22. Hold a custom persona 1.5s — copy its JSON to clipboard to share
23. Switching personas clears the current chat
24. Custom personas save as .json files in LANGAMUSICHUB/PERSONAS/

TIPS
25. Short click TUTORIAL — copies this help text
26. Settings & RGB preferences save to data.txt]]
                setclipboard(msg)
